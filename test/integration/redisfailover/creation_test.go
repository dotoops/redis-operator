...
import (
	...
	redisfailoverclientset "github.com/dotoops/redis-operator/client/k8s/clientset/versioned"
	"github.com/dotoops/redis-operator/cmd/utils"
	...
	"github.com/dotoops/redis-operator/service/k8s"
	"github.com/dotoops/redis-operator/service/redis"
)
